...
final class SearchRetentionDataSourceDiagnostics {
  ...
  private SearchRetentionDataSourceDiagnostics() {}
  ...
  static Snapshot evaluate(
      SearchRetentionDataSourceProperties properties, javax.sql.DataSource retentionDataSource) {
