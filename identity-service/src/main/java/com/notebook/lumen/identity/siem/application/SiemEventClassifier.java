...
public class SiemEventClassifier {
  ...
  public Optional<ClassifiedEvent> classify(String eventType) {
    ...
    return switch (v) {
      ...
      case "REFRESH_TOKEN_REVOKED", "REFRESH_TOKENS_REVOKED_ALL" -> Optional.of(new ClassifiedEvent("TOKEN_REVOCATION", "HIGH"));
      case "MFA_ENABLED", "MFA_RECOVERY_CODE_USED", "MFA_CREDENTIAL_REVOKED" -> Optional.of(new ClassifiedEvent("MFA", "HIGH"));
      case "SCIM_USER_DEPROVISIONED", "SCIM_AUTH_FAILED" -> Optional.of(new ClassifiedEvent("SCIM", "HIGH"));
      case "USER_REFRESH_TOKENS_REVOKED_BY_SCIM" -> Optional.of(new ClassifiedEvent("SCIM", "HIGH"));
      case "SSO_LOGIN_SUCCESS", "SSO_LOGIN_FAILED", "SSO_DISABLED", "SSO_STATE_INVALID", "SSO_STATE_EXPIRED" ->
