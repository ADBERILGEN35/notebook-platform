...
/**
 * Safe retention datasource diagnostics (Faz 113). No JDBC URLs, credentials, or raw SQL errors.
 */
final class ContentRetentionDataSourceDiagnostics {
  ...
  private ContentRetentionDataSourceDiagnostics() {}
  ...
  static Snapshot evaluate(
      ContentRetentionDataSourceProperties properties, javax.sql.DataSource retentionDataSource) {
