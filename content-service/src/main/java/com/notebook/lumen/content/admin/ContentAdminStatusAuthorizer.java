...
@Component
public class ContentAdminStatusAuthorizer {
  public static final String HEADER_NAME = "X-Service-Authorization";
  public static final String REQUIRED_SCOPE = "internal:admin:status:read";

  private final AuditAdminProperties properties;

  public ContentAdminStatusAuthorizer(AuditAdminProperties properties) {
  ...
  public void authorize(String serviceAuthorization) {
    if (serviceAuthorization == null || serviceAuthorization.isBlank()) {
      throw new ContentException(
          HttpStatus.UNAUTHORIZED, "INTERNAL_AUTH_REQUIRED", "Internal status auth is required");
    }
