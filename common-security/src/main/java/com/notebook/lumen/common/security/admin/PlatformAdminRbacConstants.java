...
public final class PlatformAdminRbacConstants {
  ...
  public static final String ROLE_PLATFORM_CHANGE_REQUEST_APPROVER = "PLATFORM_CHANGE_REQUEST_APPROVER";
  ...
  public static final String PERM_SECURITY_CHANGE_REQUEST_CREATE = "admin:security:change-request:create";
  ...
  public static final String PERM_NOTIFICATIONS_DEAD_LETTER_READ = "admin:notifications:dead-letter:read";
  public static final String PERM_NOTIFICATIONS_DEAD_LETTER_REQUEUE = "admin:notifications:dead-letter:requeue";
  public static final String PERM_NOTIFICATIONS_RETENTION_READ = "admin:notifications:retention:read";
  public static final String PERM_NOTIFICATIONS_RETENTION_RUN = "admin:notifications:retention:run";
  public static final String PERM_NOTIFICATIONS_LEGAL_HOLD_READ = "admin:notifications:legal-hold:read";
  public static final String PERM_NOTIFICATIONS_LEGAL_HOLD_WRITE = "admin:notifications:legal-hold:write";
}
