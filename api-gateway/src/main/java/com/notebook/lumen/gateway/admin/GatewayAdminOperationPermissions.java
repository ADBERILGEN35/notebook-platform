...
public final class GatewayAdminOperationPermissions {
  ...
  private static final Map<String, String> BY_OPERATION =
      Map.of(
          ...
          "MERGE_ANALYSIS_ROLLOUT_REQUEST", PlatformAdminRbacConstants.PERM_MERGE_CHANGE_REQUEST_CREATE,
          "MERGE_APPLY_ROLLOUT_REQUEST", PlatformAdminRbacConstants.PERM_MERGE_CHANGE_REQUEST_CREATE,
          "SCIM_BULK_ROLLOUT_REQUEST", PlatformAdminRbacConstants.PERM_SCIM_CHANGE_REQUEST_CREATE,
          "ADMIN_RBAC_ROLE_GRANT_REQUEST", PlatformAdminRbacConstants.PERM_RBAC_CHANGE_REQUEST_CREATE,
          "ADMIN_RBAC_ROLE_REVOKE_REQUEST", PlatformAdminRbacConstants.PERM_RBAC_CHANGE_REQUEST_CREATE);
