...
@Component
public class SearchRetentionClient {

  static final String READ_SCOPE = "internal:admin:retention:read";
  static final String SEARCH_AUDIENCE = "search-service";

  private final GatewaySearchRetentionProperties properties;
  private final ServiceJwtSigner serviceJwtSigner;
  private final WebClient webClient;

  public SearchRetentionClient(
      GatewaySearchRetentionProperties properties,
  ...
  public Mono<Map<String, Object>> fetchPlan(Collection<String> legalHoldScopes, String requestId) {
    ...
    return Mono.defer(
        () -> {
          String jwt;
          try {
            jwt = serviceJwtSigner.sign(SEARCH_AUDIENCE, READ_SCOPE);
  ...
  private String baseUrl() {
    ...
    if (base == null || base.isBlank()) base = "http://search-service:8085";
    while (base.endsWith("/")) base = base.substring(0, base.length() - 1);
    return base + "/internal/admin/retention/search/plan";
  }
