...
@Service
public class BreakGlassSessionsProxyService {
  static final String BREAK_GLASS_SESSIONS_READ_SCOPE = "internal:admin:break-glass:events:read";
  static final String BREAK_GLASS_SESSIONS_REVOKE_SCOPE =
  ...
  public BreakGlassSessionsProxyService(
  ...
  public Mono<ResponseEntity<Object>> list(
    ...
    return withAuthGet(
        baseUrl(), BREAK_GLASS_SESSIONS_READ_SCOPE, adminUserId, requestId, gatewayPath);
  }

  public Mono<ResponseEntity<Object>> revoke(
      String jti, Map<String, Object> body, String adminUserId, String requestId, String path) {
    return withAuthPost(
        baseUrl() + "/" + jti + "/revoke",
        BREAK_GLASS_SESSIONS_REVOKE_SCOPE,
        body,
        adminUserId,
        requestId,
        path);
  ...
  public Mono<ResponseEntity<Object>> revokeAllActive(
      Map<String, Object> body, String adminUserId, String requestId, String path) {
    return withAuthPost(
        baseUrl() + "/revoke-all-active",
        BREAK_GLASS_SESSIONS_REVOKE_SCOPE,
        body,
        adminUserId,
        requestId,
  ...
  private Mono<ResponseEntity<Object>> withAuthPost(
      String url,
      String scope,
    ...
    return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
        ...
        .body(
            new ErrorResponse(
                ...
                "Service JWT signing failed for break-glass sessions proxy",
                path,
                requestId,
                null));
  }
  ...
  private String baseUrl() {
    ...
    return base + "/internal/admin/break-glass/sessions";
  }
}
