...
public class EmailProviderConfig {
  @Bean
  EmailProvider emailProvider(NotificationProperties properties, MeterRegistry meterRegistry) {
    ...
    return switch (provider.toLowerCase()) {
      ...
      case "generic-http" ->
          new GenericHttpEmailProvider(
              properties.email().genericHttp(), "generic-http", meterRegistry);
      case "sendgrid" ->
          new GenericHttpEmailProvider(properties.email().genericHttp(), "sendgrid", meterRegistry);
