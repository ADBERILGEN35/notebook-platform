...
final class WorkspaceRetentionDataSourceDiagnostics {
  ...
  private WorkspaceRetentionDataSourceDiagnostics() {}
  ...
  static Snapshot evaluate(
      WorkspaceRetentionDataSourceProperties properties, javax.sql.DataSource retentionDataSource) {
